...
<title>注册-${applicationScope.bbsinfo.name}</title>
 ...
 function submitInfo(){
	 if(isusername()&&ispwd()&&isqpwd()&&isVerifyCode()){
		 var param={};
 ...
 function updateyanzhengma(){
     document.getElementById('yanzhengmaimg').src= '${path}/vercode/setCode.do?t='+new Date().getTime();
      ...
      <form method="post" id="form">
           ...
           <table> 
            <tbody>
             ...
             <tr > 
              ...
              <input style="width: 125px;margin-top: -20px;" type="text" name="yanzhengma" id="yanzhengma" class="px"  size="4" maxlength="4"  onblur="isVerifyCode();"/>
              <img src="${path}/vercode/setCode.do" alt="验证码" height="30px;" id="yanzhengmaimg" onclick="updateyanzhengma();"/>
              </td> 
              <td class="tipcol" colspan="3">
       ...
       <div id="layer_reginfo_b"> 
        <div class="rfmrig mbw"> 
         <span id="reginfo_a_btn"> <em>&nbsp;</em> <input class="btn"  type="button" id="zhucbut" value="立即注册" onclick="submitInfo();"/> </span> 
        </div> 
       </div> 
      </form> 
     </div> 
