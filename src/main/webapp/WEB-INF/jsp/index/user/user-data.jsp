       ...
       <table cellspacing="0" cellpadding="0" class="tfm" id="profilelist"> 
        <tbody>
         ...
         <tr id="tr_realname"> 
          ...
          <td id="td_realname"> 
          <input type="hidden" name="avatar" id="img" class="px" value="${sessionScope.indexuser.avatar}"  />
          <img src="<%=request.getContextPath()%>/file/${sessionScope.indexuser.avatar}" width="80px;" height="80px" id="img1" />
         ...
         <tr id="tr_birthday"> 
          ...
          <td id="td_birthday"> 
         <input name="motto" id="motto" value="${sessionScope.indexuser.motto}" class="px"/>
           <div class="rq mtn" id="showerror_birthday"></div><p class="d"></p></td> 
         </tr> 
         <tr> 
          <th>&nbsp;</th> 
    ...
    <div class="appl">
     <div class="tbn"> 
      ...
      <ul> 
       ...
       <li ><a href="${path}/user/toRepwd.do">密码安全</a></li>
       <%--<li><a href="${path}/user/jifen/index.do">积分</a></li>
       <li><a href="${path}/user/message/index.do">消息</a></li> --%>
      </ul> 
     </div>
    </div> 
   </div> 
