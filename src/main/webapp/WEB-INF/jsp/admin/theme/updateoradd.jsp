...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${path}/admin/theme/update.do" id="form">
            <div class="form-group">
                <div class="label">
                    <label>名称：</label>
                </div>
                <div class="field">
                    <input type="text" class="input" name="name" value="${theme.name}" size="100" id="name"/>
                    <input type="hidden" name="id" value="${theme.id}"/>
                    <input type="hidden" name="sectionid" value="${theme.sectionid}"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="orderby" value="${theme.orderby}" size="10" id="orderby"/>
