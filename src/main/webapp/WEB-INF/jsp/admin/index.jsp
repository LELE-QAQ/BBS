...
<div class="leftnav">
  ...
  <ul>
    ...
    --%>
    <li><a href="${path}/admin/section/index.do" target="right"><span class="icon-caret-right"></span>板块管理</a></li>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="${path}/admin/info/index.do" name="right" width="100%" height="100%"></iframe>
</div>
</body>
</html>