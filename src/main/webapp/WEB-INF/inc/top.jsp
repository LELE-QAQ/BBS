...
<div id="append_parent"></div> 
  <div id="toptb" class="cl"> 
   <div class="wp"> 
    <div class="z"> 
     <a href="${path}/" title="${applicationScope.bbsinfo.name}"><img src="${path}/file/${applicationScope.bbsinfo.logo}" alt="${applicationScope.bbsinfo.name}" /></a>
    </div> 
    ...
    <div class="y"> 
     ...
     <c:if  test="${!empty sessionScope.indexuser}">
      ...
      <div id="login_user_menu" class="qing_user_pop">
       <a href="${path}/member/${sessionScope.indexuser.id}_1.html" class="qing_userinfo_avtar" target="_blank">
        ...
        <img src="${path}/file/${sessionScope.indexuser.avatar}" /></a>
     ...
     <c:if  test="${empty sessionScope.indexuser}">
      ...
      <a href="${path}/regist/toRegist.do" >立即注册</a>
     </c:if>
     </div> 
