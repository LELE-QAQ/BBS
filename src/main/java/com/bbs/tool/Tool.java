...
public class Tool {
	...
	public static boolean isAdmin(User user){
		if(user.getRoleId()== com.bbs.tool.PublicStatic.GROUPBANZHU||user.getRoleId()== com.bbs.tool.PublicStatic.GROUPADMIN){
			return false;
		}else{
			return true;
		}
...
//    			System.out.println("4");
	...
	public static boolean isstopip(HttpServletRequest request,
		...
		List<StopIp> stopipList = cn.bbs.tool.PublicStatic.stopipList;
